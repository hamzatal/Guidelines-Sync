    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
            <Head>
                ...
                <meta
                    name="description"
                    content="Manage your bookings, destinations, offers, and packages with Guidelines Sync."
                />
            </Head>
            ...
            <section className="relative h-80 md:h-80 w-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[url('/images/background.jpg')] bg-no-repeat bg-center opacity-50"></div>
